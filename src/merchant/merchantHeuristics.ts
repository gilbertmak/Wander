...
export const merchantSeeds: MerchantSeed[] = [
  ...
  },
  {
    ...
    canonicalName: "Shell",
    defaultCategoryId: "category_transport",
    defaultMccId: "mcc_5541",
    country: "SG",
  },
  {
    id: "merchant_singapore_airlines",
    canonicalName: "Singapore Airlines",
    defaultCategoryId: "category_travel",
    defaultMccId: "mcc_4511",
    country: "SG",
  },
  {
    id: "merchant_singtel",
  ...
  {
    id: "merchant_school",
    canonicalName: "School Fees",
    defaultCategoryId: "category_education",
    defaultMccId: "mcc_8211",
    country: "SG",
  },
  {
    id: "merchant_cardup",
    canonicalName: "CardUp",
    defaultCategoryId: "category_financial_services",
    defaultMccId: "mcc_6012",
    country: "SG",
  },
  {
    id: "merchant_credit_card_payment",
    canonicalName: "Credit Card Bill Payment",
    defaultCategoryId: "category_financial_services",
    defaultMccId: "mcc_6012",
    country: "SG",
  },
...
export const merchantHeuristicSeeds: MerchantHeuristicSeed[] = [
  ...
  heuristic(
    ...
    "regex",
    "\\b(credit card payment|card bill payment|payment thank you)\\b",
    "mcc_6012",
